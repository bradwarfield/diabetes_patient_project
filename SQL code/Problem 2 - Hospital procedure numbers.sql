/* Query to determine list of specialties and the average number of procedures per encounter for each specialty
that has more than 2.5 procedures per encounter */
...
HAVING mean_procedures_per_encounter > 2.5
    AND tot_encounters > 50
ORDER BY mean_procedures_per_encounter DESC
;